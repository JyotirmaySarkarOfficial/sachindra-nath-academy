...
function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-blue-950/95 backdrop-blur-md text-white shadow-lg z-50">
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 px-4 lg:px-6 py-4">
        ...
        <Link
          ...
          <div>
            ...
            <h1 className="text-xl lg:text-2xl font-bold tracking-wide whitespace-nowrap">
