const founderMessage = {
  ...
  message: `
    ...
    At our academy, we continuously strive to create an inspiring environment where students can discover their potential and grow into confident future leaders.
  `,
